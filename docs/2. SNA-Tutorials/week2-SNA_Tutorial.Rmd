---
title: "SNA Tutorials: Week 2: Network Structure"
...
### Vetex Attribute & Edge Attribute 
A *vertex attribute* is a vector (or variable) of additional information about the nodes in a network dataset:
name, location, demographic information about the actors or organizations  comprise the vertices of the network. 

In case you have forgotten, we can 
[statnet]
``` print(DataSet.stat) 
```

*edge attribute* is a vector (or variable) of additional information about the edges or relationships in a network dataset. The most common edge attribute is weight, in a weighted dataset.
### Network Structure
...
# Network Structure [Week 2]
aspects of network structure introduced in the Week 2 Lecture:
- Dyads and Dyad Census
  *dyad census* gives the number of dyads where the relationship is:
    - Reciprocal (mutual), or mut
    - Asymmetric (non-mutual), or asym, and
