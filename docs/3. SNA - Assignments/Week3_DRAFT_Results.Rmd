...
**Smuggler's Cove Edge-list contains:**
...
-   and how to interpret the value of the tie if
    any.

-   Whether or not there are edge attributes that
    might be used to:
...
## 1. the relevant statistics and interpretation. For example, explaining which node(s) are most central and which are least central.
