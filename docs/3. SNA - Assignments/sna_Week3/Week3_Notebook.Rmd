...
```
IGRAPH 574c3d4 UN-- 274 672 -- 
+ attr: name (v/c), 
        dnkName (v/c), 
        dnkIng (e/c),
      | ingType (e/c)
+ edges from 574c3d4 (vertex names):
...
```{r iGraph:Local transitivity: Node List & Ego Network, echo=TRUE}
