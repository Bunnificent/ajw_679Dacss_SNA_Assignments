...
```{r statnet: grecip: dyadic reciprocity & Mutuality, echo=TRUE}
library(statnet)
library(sna)
...
summary(
igEL_guTrans <- transitivity(igEL,
...
transitivity(igEL,
             type="local", 
             vids=V(igEL)[c(
               "AKU AKU", "SINGAPORE SLING", "HONDO HATTIE'S JUNGLE PUNCH!")]
               )
```
